...
public class BlurDialogEngine {
    ...
    /**
     * Default value for whether background contains map fragment
     */
    static final boolean DEFAULT_MAP_BACKGROUND = false;
    ...
    /**
     * Hack to make sure dialog works with GMaps in a background fragment
     */
    private Bitmap mCustomBackgroundSnapshot;
    ...
    public void setCustomBackgroundBitmap(Bitmap snapshot) { mCustomBackgroundSnapshot = snapshot; }
    ...
    private void blur(Bitmap bkg, View view) {
        ...
        // hack to make blurred background work with Google Map Fragments
        if (mCustomBackgroundSnapshot != null) {
            canvas.drawBitmap(mCustomBackgroundSnapshot, null, destRect, paint);
        } else {
